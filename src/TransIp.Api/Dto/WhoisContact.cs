...
namespace TransIp.Api.Dto
{
	...
	public class WhoisContact
	{
		...
		public WhoisContactType Type { get; set; }
		...
		/// <summary>
		/// The company name of this Contact, in case of a company.
		/// </summary>
		[DataMember(Name = "companyName")]
		public string CompanyName { get; set; }

		/// <summary>
		/// The company number of this Contact, in case of a company.
		/// </summary>
		[DataMember(Name = "companyKvk")]
		...
		/// <summary>
		/// The postal code part of the address of this Contact.
		/// </summary>
	...
	/// <summary>
	/// The available contact types.
	/// </summary>
	public enum WhoisContactType
	{
		Registrant,
		Administrative,
		Technical
